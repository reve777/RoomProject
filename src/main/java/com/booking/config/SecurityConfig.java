    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Static resources & Frontend SPA (including registration and line auth page)
                .requestMatchers("/", "/index.html", "/register.html", "/line-auth.html", "/favicon.ico", "/css/**", "/js/**", "/components/**", "/uploads/**").permitAll()
