...
public class BookingController {
    ...
    @RequestMapping(value = "/bookings/{id}/cancel", method = {RequestMethod.PUT, RequestMethod.POST})
    ...
    @GetMapping({"/bookings/admin/all", "/admin/bookings"})
    ...
    @PutMapping({"/bookings/admin/{id}/status", "/admin/bookings/{id}/status"})
    @PreAuthorize("hasRole('ADMIN')")
